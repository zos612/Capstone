...
public class insertDAO {
  ...
  public static boolean create(DTO dto) throws Exception {
   ...
   String name = dto.getModel();
   String url = dto.getUrl();
   String review = dto.getReview();
   String sql = "INSERT INTO model_img_spec(category, image, spec) VALUES";
   
   System.out.println(name+" "+url+" "+review);
...
//      + new String(review.getBytes(), "ISO-8859-1") + "')";
