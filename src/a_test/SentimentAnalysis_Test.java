...
import a_test.algorithms.FeatureExtraction;
...
public class SentimentAnalysis_Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String document = "안녕하세요.디자인이 예뻐요.이 물건은 배송이 빨라서 정말 좋네요.소리가 작아서 좋아요.소리가 너무 커요.가습량이 많지 않네요.분무량이  많아요.\n";
